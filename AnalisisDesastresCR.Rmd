...
Y finalmente, un app en Shiny que permita seleccionar el periodo de tiempo, mostrando un mapa de los eventos y la tabla con las descripciones de los eventos del periodo elegido.
